    ...
    public static void InitializeFirebaseApp()
    {
        if (firebaseApp == null)
        {
            try
            {
                ...
                if (defaultApp == null)
                {
                    string serviceAccountKeyPath = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Firebase", "realtimechatapplicationg10-firebase-adminsdk-fbsvc-cef6dbf2e4.json");
